...
export default function App() {
  ...
  async function handleCompare(image1, image2) {
    ...
    Object.values(sources).forEach((source) => source && URL.revokeObjectURL(source));
